  ...
  return (
    <div className='w-full flex justify-center items-center flex-col py-16 px-3 md:p-24 gap-5'>
      ...
      <h1 className=' text-2xl md:text-4xl font-bold '><Binary className="inline text-lime-500" /> Welcome <Binary className="inline text-lime-500" /></h1>
        <p className='text-base md:text-2xl'>For a start check out the tool box up top, select a genre then a topic.</p>
      ...
      <div className="">
        <p className='text-base md:text-lg p-1'><span className='font-bold underline'>Most Viewed Button</span> : analyze the top 20 youtube videos based on the given topic and then generate 20 titles similer to those titles.</p>
        <p className='text-base md:text-lg p-1'><span className='font-bold underline'>Ai Button</span> : 20 titles generated by ChatGPT base on the given topic.</p>
      </div>
      <div className="">
        <NavLink to={"../../contact"}>
