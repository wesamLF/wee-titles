...
exports.titlesFromAiPrompt = exports.titlesFromTrendingPrompt = void 0;
function titlesFromTrendingPrompt(titles) {
    return [
...
exports.titlesFromTrendingPrompt = titlesFromTrendingPrompt;
function titlesFromAiPrompt(tobic) {
    return [
...
exports.titlesFromAiPrompt = titlesFromAiPrompt;
